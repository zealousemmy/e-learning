    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-lg-4 responsive-column-half">
          <div className="card card-item dashboard-info-card">
            <div className="card-body d-flex align-items-center">
              <div className="icon-element flex-shrink-0 bg-1 text-white">
                <svg
              ...
              <div className="pl-4">
                <p className="card-text fs-18">Enrolled Courses</p>
                <h5 className="card-title pt-2 fs-26">11</h5>
              </div>
            </div>
            {/* <!-- end card-body --> */}
          </div>
        ...
        <div className="col-lg-4 responsive-column-half">
          <div className="card card-item dashboard-info-card">
            <div className="card-body d-flex align-items-center">
              <div className="icon-element flex-shrink-0 bg-2 text-white">
                <svg
                  class="svg-icon-color-white"
                  width="40"
                  version="1.1"
              ...
              <div className="pl-4">
                <p className="card-text fs-18">Active Courses</p>
                <h5 className="card-title pt-2 fs-26">5</h5>
              </div>
            </div>
            {/* <!-- end card-body --> */}
          </div>
        ...
        <div className="col-lg-4 responsive-column-half">
          <div className="card card-item dashboard-info-card">
            <div className="card-body d-flex align-items-center">
              <div className="icon-element flex-shrink-0 bg-3 text-white">
                <svg
                  class="svg-icon-color-white"
                  width="40"
                  version="1.1"
              ...
              <div className="pl-4">
                <p className="card-text fs-18">Completed Courses</p>
                <h5 className="card-title pt-2 fs-26">6</h5>
              </div>
            </div>
            {/* <!-- end card-body --> */}
          </div>
        ...
        <div className="col-lg-4 responsive-column-half">
          <div className="card card-item dashboard-info-card">
            <div className="card-body d-flex align-items-center">
              <div className="icon-element flex-shrink-0 bg-4 text-white">
                <svg
                  class="svg-icon-color-white"
                  width="40"
                  version="1.1"
              ...
              <div className="pl-4">
                <p className="card-text fs-18">Total Students</p>
                <h5 className="card-title pt-2 fs-26">30,405</h5>
              </div>
            </div>
            {/* <!-- end card-body --> */}
          </div>
        ...
        <div className="col-lg-4 responsive-column-half">
          <div className="card card-item dashboard-info-card">
            <div className="card-body d-flex align-items-center">
              <div className="icon-element flex-shrink-0 bg-5 text-white">
                <svg
                  class="svg-icon-color-white"
                  width="40"
                  version="1.1"
              ...
              <div className="pl-4">
                <p className="card-text fs-18">Total Courses</p>
                <h5 className="card-title pt-2 fs-26">11</h5>
              </div>
            </div>
            {/* <!-- end card-body --> */}
        ...
        <div className="col-lg-4 responsive-column-half">
          <div className="card card-item dashboard-info-card">
            <div className="card-body d-flex align-items-center">
              <div className="icon-element flex-shrink-0 bg-6 text-white">
                <svg
                  class="svg-icon-color-white"
                  width="40"
                  viewBox="0 0 512 512"
              ...
              <div className="pl-4">
                <p className="card-text fs-18">Total Earnings</p>
                <h5 className="card-title pt-2 fs-26">289.12</h5>
              </div>
            </div>
            {/* <!-- end card-body --> */}
          </div>
        ...
        <div className="col-lg-4 responsive-column-half">
          <div className="card card-item">
            <div className="card-body">
              <h3 className="fs-18 font-weight-semi-bold pb-4">Total Sales</h3>
              <canvas id="doughnut-chart"></canvas>
              <div id="legend" className="mt-40px text-center"></div>
            </div>
          </div>
          {/* <!-- end card --> */}
        </div>
        ...
        <div className="col-lg-4 responsive-column-half">
          <div className="card card-item">
            <div className="card-body">
              <h3 className="fs-18 font-weight-semi-bold pb-4">Net Income</h3>
              <canvas id="bar-chart"></canvas>
              <ul className="chart-legend mt-40px text-center">
                <li>Sales htmlFor this month</li>
              </ul>
            </div>
          </div>
          {/* <!-- end card --> */}
        ...
        <div className="col-lg-4">
          <div className="card card-item">
            <div className="card-body">
              <h3 className="fs-18 font-weight-semi-bold pb-4">
                Earning by Location
              </h3>
              <div className="my-course-progress-bar-wrap">
                <div className="d-flex flex-wrap align-items-center mb-2 position-relative">
                  <p className="skillbar-title">USA:</p>
                ...
                <div className="d-flex flex-wrap align-items-center mb-2 position-relative">
                  <p className="skillbar-title">UK:</p>
                  <div className="skillbar-box">
                    <div
                      className="skillbar skillbar-skillbar-2"
                      data-percent="70%"
                    >
                      <div className="skillbar-bar skillbar--bar-2 bg-2"></div>
                    </div>
                    {/* <!-- End Skill Bar --> */}
                  </div>
                ...
                <div className="d-flex flex-wrap align-items-center mb-2 position-relative">
                  <p className="skillbar-title">China:</p>
                  <div className="skillbar-box">
                    <div
                      className="skillbar skillbar-skillbar-2"
                      data-percent="60%"
                    >
                      <div className="skillbar-bar skillbar--bar-2 bg-3"></div>
                    </div>
                    {/* <!-- End Skill Bar --> */}
                  </div>
                ...
                <div className="d-flex flex-wrap align-items-center mb-2 position-relative">
                  <p className="skillbar-title">Canada:</p>
                  <div className="skillbar-box">
                    <div
                      className="skillbar skillbar-skillbar-2"
                      data-percent="50%"
                    >
                      <div className="skillbar-bar skillbar--bar-2 bg-4"></div>
                    </div>
                    {/* <!-- End Skill Bar --> */}
                  </div>
                ...
                <div className="d-flex flex-wrap align-items-center mb-2 position-relative">
                  <p className="skillbar-title">Brazil:</p>
                  <div className="skillbar-box">
                    <div
                      className="skillbar skillbar-skillbar-2"
                      data-percent="40%"
                    >
                      <div className="skillbar-bar skillbar--bar-2 bg-5"></div>
                    </div>
                    {/* <!-- End Skill Bar --> */}
                  </div>
                ...
                <div className="d-flex flex-wrap align-items-center mb-2 position-relative">
                  <p className="skillbar-title">Russia:</p>
                  <div className="skillbar-box">
                    <div
                      className="skillbar skillbar-skillbar-2"
                      data-percent="30%"
                    >
                      <div className="skillbar-bar skillbar--bar-2 bg-6"></div>
                    </div>
                    {/* <!-- End Skill Bar --> */}
                  </div>
                ...
                <div className="d-flex flex-wrap align-items-center mb-2 position-relative">
                  <p className="skillbar-title">Australia:</p>
                  <div className="skillbar-box">
                    <div
                      className="skillbar skillbar-skillbar-2"
                      data-percent="20%"
                    >
                      <div className="skillbar-bar skillbar--bar-2 bg-7"></div>
                    </div>
                    {/* <!-- End Skill Bar --> */}
                  </div>
        ...
        {/* <!-- end col-lg-4 --> */}
        <div className="col-lg-7 responsive-column-half">
          <div className="card card-item">
            <div className="card-body">
              ...
              <ul className="chart-legend mt-40px text-center">
                <li>Earnings htmlFor this month</li>
              </ul>
            </div>
          </div>
          {/* <!-- end card --> */}
